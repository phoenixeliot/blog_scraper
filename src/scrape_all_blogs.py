...
filenames = os.listdir(
    os.path.realpath(os.path.join(os.path.dirname(__file__), f"../blog_configs"))
)
...
for yml_filename in yml_filenames:
    ...
    log_filename = os.path.realpath(
        os.path.join(os.path.dirname(__file__), "../logs", f"{filename_root}.log")
    )
